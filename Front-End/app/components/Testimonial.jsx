        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-3xl font-bold leading-tight text-gray-800 sm:text-4xl lg:text-5xl">
              Trusted by <span className="text-cyan-600">30k+</span> world class
              ...
              <div className="px-8 py-12">
                <div className="relative w-24 h-24 mx-auto">
                  <img
                    ...
                    alt=""
                  />
                  <div className="absolute top-0 right-0 flex items-center justify-center bg-cyan-600 rounded-full w-7 h-7">
                    <svg
